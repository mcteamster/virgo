...
export default function Cards({ location, awsRegion }: Props) {
  return (
    <div style={styles.container}>
      ...
      <div style={{ ...styles.card, backgroundColor: '#4DBD96' }} onClick={() => { window.open(`https://maps.apple.com/frame?center=${location.latitude}%2C${location.longitude}&span=4%2C10`, '_blank') }}>
      ...
      <div style={{ ...styles.card, backgroundColor: '#F0920A' }} onClick={() => { window.open('https://aws.amazon.com/about-aws/global-infrastructure/', '_blank') }}>
