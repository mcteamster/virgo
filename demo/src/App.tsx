...
function App() {
  ...
  return (
    <div style={styles.body}>
      ...
      <div style={styles.card} onClick={() => { window.open(`https://maps.apple.com/frame?center=${location.latitude}%2C${location.longitude}&span=4%2C10`, '_blank')}}>
      ...
      <div style={styles.card} onClick={() => { window.open('https://aws.amazon.com/about-aws/global-infrastructure/', '_blank')}}>
